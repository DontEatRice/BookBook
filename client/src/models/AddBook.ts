...
const AddBook = z.object({
  ...
  yearPublished: z
    .preprocess((a) => parseInt(z.string().parse(a)), z.number().positive('Liczba musi być dodatnia'))

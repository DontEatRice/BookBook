...
function UpdateReviewForm({ review, book, handleClose }: { review: ReviewViewModelType, book: BookViewModelType, handleClose: () => void }) {
        ...
        <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', justifyContent: 'center' }}>
          <Box
            ...
            <Paper sx={{ p: 2, width: '100%' }} elevation={3}>
              ...
              />
              <TextInputField errors={errors} field="title" register={register} label="Tytuł" defaultValue={review.title+""} />
              <TextInputBox rows={10} errors={errors} field="description" register={register} label="Komentarz" defaultValue={review.description+""} />

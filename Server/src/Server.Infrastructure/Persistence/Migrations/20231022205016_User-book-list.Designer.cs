...
namespace Server.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231022205016_User-book-list")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookIdentity", b =>
                {
                    b.Property<Guid>("BooksObservedId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("UsersObservingId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("BooksObservedId", "UsersObservingId");

                    b.HasIndex("UsersObservingId");

                    b.ToTable("BookIdentity");
                });
            ...
            modelBuilder.Entity("BookIdentity", b =>
                {
                    b.HasOne("Server.Domain.Entities.Book", null)
                        .WithMany()
                        .HasForeignKey("BooksObservedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Server.Domain.Entities.Auth.Identity", null)
                        .WithMany()
                        .HasForeignKey("UsersObservingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
